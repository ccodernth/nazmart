...
@section('title')
    {{__('All Support Ticket Category')}}
@endsection
                ...
                <x-admin.header-wrapper>
                    ...
                    <x-slot name="right" class="d-flex">
                        ...
                        <button class="btn btn-info btn-sm mb-3" data-bs-toggle="modal"
                                data-bs-target="#new_support_department_category">{{__('Add New Department')}}</button>
                    </x-slot>
                </x-admin.header-wrapper>
                        ...
                        @foreach($all_category as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endcan
                                    <x-delete-popover permissions="support-ticket-department-delete"
                                                      url="{{route(route_prefix().'admin.support.ticket.department.delete', $data->id)}}"/>
                                </td>
                            </tr>
                        @endforeach
                    </x-slot>
    ...
    <script>
        $(document).ready(function ($) {
            ...
            $(document).on('click', '.support_department_edit_btn', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('landlord.admin.support.ticket.department.get-category-translate') }}", // POST isteğinin gideceği URL'yi buraya yazın
                    data: {
