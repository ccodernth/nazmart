                                            ...
                                            @foreach(get_all_language() as $language)
                                                ...
                                                <div class="tab-pane fade show {{ $loop->iteration == 1 ? 'active' : '' }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"  name="translate[{{$language->slug}}][title]" value="{{ $attribute->getTranslations()['title'][$language->slug] ?? ''}}" placeholder="{{__('Title')}}">
                                                    </div>

                                                    <div class="form-group attributes-field product-attributes">
                                                        <label for="attributes">{{__('Terms')}}</label>
                                                        @forelse(json_decode($attribute->getTranslations()['terms'][$language->slug]) as $terms)
                                                            <div class="attribute-field-wrapper">
                                                                <input type="text" class="form-control" name="translate[{{$language->slug}}][terms][]" value="{{$terms}}">
