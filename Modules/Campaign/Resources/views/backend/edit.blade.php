                                                        ...
                                                        @foreach(get_all_language() as $language)
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="edit_name">{{__('Campaign Name')}}</label>
                                                                    <input type="text" class="form-control"
                                                                           id="translate-{{$language->slug}}-campaign_name"
                                                                           name="translate[{{$language->slug}}][campaign_name]"
                                                                           placeholder="{{__('Campaign Name')}}"
                                                                           value="{{ $campaign->getTranslations()['title'][$language->slug] ?? ''}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="edit_name">{{__('Campaign Subtitle')}}</label>
                                                                    <input type="text" class="form-control"
                                                                           id="translate-{{$language->slug}}-campaign_subtitle"
                                                                           name="translate[{{$language->slug}}][campaign_subtitle]"
                                                                           placeholder="{{__('Campaign Subtitle')}}"
                                                                           value="{{ $campaign->getTranslations()['subtitle'][$language->slug] ?? '' }}">
                                                                </div>
