...
enum AdminGetRoutesEnum
{
    public static function landlordAdminRoutes():  array
    {
        return [
			...
			'landlord.admin.payment.settings.payriff' => 'payriff settings',
			'landlord.admin.payment.settings.kapital' => 'kapital settings',
    ...
    public static function tenantAdminRoutes():  array
    {
        $generalRoutes = [
			...
			'tenant.admin.payment.settings.kapital' => 'Kapital Settings',
			'tenant.admin.payment.settings.payriff' => 'Payriff Settings',
