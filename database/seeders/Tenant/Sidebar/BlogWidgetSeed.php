...
class BlogWidgetSeed extends Seeder
{
    public function generateLanguage($data)
    {
        ...
        foreach ($allLanguages as $language) {
            $result[$language->slug] = serialize($data);
        }
        return $result;
    }
    ...
    public function run()
    {
        ...
        Widgets::create([
            ...
            'widget_content' => $this->generateLanguage($this->blog_search_content()),
        ]);
        ...
        Widgets::create([
            ...
            'widget_order' => '2',
            'widget_location' => 'sidebar',
            'widget_content' => $this->generateLanguage($this->blog_category_content()),
        ]);
        ...
        Widgets::create([
            ...
            'widget_order' => '2',
            'widget_location' => 'sidebar',
            'widget_content' => $this->generateLanguage($this->recent_blog_content()),
        ]);
