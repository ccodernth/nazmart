...
class HomePageAddon extends Seeder
{
    ...
    public function run()
    {
        ...
        PageBuilder::create([
            ...
            'addon_settings' => $this->generateLanguage($this->header_content()),
        ]);
        ...
        PageBuilder::create([
            ...
            'addon_order' => 3,
            'addon_page_type' => 'dynamic_page',
            'addon_settings' => $this->generateLanguage($this->price_plan_content()),
        ]);
        ...
        PageBuilder::create([
            ...
            'addon_order' => 4,
            'addon_page_type' => 'dynamic_page',
            'addon_settings' => $this->generateLanguage($this->app_of_the_month_content()),
        ]);
        ...
        PageBuilder::create([
            ...
            'addon_order' => 6,
            'addon_page_type' => 'dynamic_page',
            'addon_settings' => $this->generateLanguage($this->support_two_content()),
        ]);
        ...
        PageBuilder::create([
            ...
            'addon_order' => 8,
            'addon_page_type' => 'dynamic_page',
            'addon_settings' => $this->generateLanguage($this->blog_content()),
        ]);
