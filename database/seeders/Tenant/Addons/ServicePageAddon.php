...
class ServicePageAddon extends Seeder
{
    ...
    public function run()
    {
        ...
        PageBuilder::create([
            ...
            'addon_settings' => $this->generateLanguage($this->how_it_work_content()),
        ]);
        ...
        PageBuilder::create([
            ...
            'addon_page_id' => 3,
            'addon_page_type' => 'dynamic_page',
            'addon_settings' => $this->generateLanguage($this->service_one_content()),
        ]);
        ...
        PageBuilder::create([
            ...
            'addon_page_id' => 3,
            'addon_page_type' => 'dynamic_page',
            'addon_settings' => $this->generateLanguage($this->counterup_content()),
        ]);
