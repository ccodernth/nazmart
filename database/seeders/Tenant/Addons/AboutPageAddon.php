...
class AboutPageAddon extends Seeder
{
    ...
    public function generateLanguage($data)
    {
        ...
        foreach ($allLanguages as $language) {
            $result[$language->slug] = json_encode($data);
        }
        return $result;
    }
    public function run()
    {
        ...
        PageBuilder::create([
            ...
            'addon_settings' => $this->generateLanguage($this->support_one_content()),
        ]);
       ...
       //Key Feature Addon
        PageBuilder::create([
            ...
            'addon_page_id' => 2,
            'addon_page_type' => 'dynamic_page',
            'addon_settings' => $this->generateLanguage($this->key_feature_content())
        ]);
        ...
        PageBuilder::create([
            ...
            'addon_page_id' => 2,
            'addon_page_type' => 'dynamic_page',
            'addon_settings' => $this->generateLanguage($this->team_member_content())
        ]);
        ...
        PageBuilder::create([
            ...
            'addon_page_id' => 2,
            'addon_page_type' => 'dynamic_page',
            'addon_settings' => $this->generateLanguage($this->portfolio_content()),
        ]);
        ...
        PageBuilder::create([
            ...
            'addon_page_id' => 2,
            'addon_page_type' => 'dynamic_page',
            'addon_settings' => $this->generateLanguage($this->organization_content()),
        ]);
        ...
        PageBuilder::create([
            ...
            'addon_page_id' => 2,
            'addon_page_type' => 'dynamic_page',
            'addon_settings' => $this->generateLanguage($this->testimonial_content()),
        ]);
        ...
        PageBuilder::create([
            ...
            'addon_page_id' => 2,
            'addon_page_type' => 'dynamic_page',
            'addon_settings' => $this->generateLanguage($this->brand_content()),
        ]);
        ...
        PageBuilder::create([
            ...
            'addon_page_id' => 2,
            'addon_page_type' => 'dynamic_page',
            'addon_settings' => $this->generateLanguage($this->get_in_touch_content()),
        ]);
