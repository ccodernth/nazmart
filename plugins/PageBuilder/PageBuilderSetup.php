...
class PageBuilderSetup
{
    ...
    private static function registerd_widgets(): array
    {
        ...
        if (!is_null(tenant()))
        {
            ...
            if ($theme == 'hexfashion')
            {
                ...
                // Theme Fruit
                //TODO:: Fruit teması için eklenen widget'lar burada yer almalı
                $addons = [
                    \Plugins\PageBuilder\Addons\Tenants\Fruit\Header\HeaderOne::class,
                    \Plugins\PageBuilder\Addons\Tenants\Fruit\Common\Services::class,
                    \Plugins\PageBuilder\Addons\Tenants\Fruit\Common\CollectionCard::class,
                    \Plugins\PageBuilder\Addons\Tenants\Fruit\Product\RecommendedProduct::class,
                    \Plugins\PageBuilder\Addons\Tenants\Fruit\Product\TrendingProducts::class,
                    \Plugins\PageBuilder\Addons\Tenants\Fruit\Common\SubscribeNewsletter::class,

                    \Plugins\PageBuilder\Addons\Tenants\Fruit\Product\BestProduct::class,
    ...
    public static function get_admin_panel_widgets($language=null): string
    {
        //TODO::Burası widget ekleme bölümünde kullanılan alandır. Temaya widget eklenecekse buradan eklenebilir
        $widgets_markup = '';
    ...
    public static function get_saved_addons_for_dynamic_page($page_type, $page_id, $location_slug): string
    {
        $output = '';
       $locale = app()->getLocale();
        app()->setLocale($location_slug);
        $all_widgets = \Cache::remember('page_id-'.$page_id, 60*60*24, function () use ($location_slug, $page_type, $page_id) {
