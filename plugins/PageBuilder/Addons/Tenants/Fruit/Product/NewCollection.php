...
class NewCollection extends PageBuilderBase
{
    ...
    public function frontend_render()
    {
        ...
        $products = $products->orderBy('created_at', $item_order != '' ? $item_order : 'desc')->withSum('taxOptions', 'rate')->take($item_show ?? 4)->get();
        ...
        return self::renderView('tenant.fruit.product.new_collection', $data);
    }

    public function addon_title()
    {
        return __('Fruit: New Collection');
    }
}
