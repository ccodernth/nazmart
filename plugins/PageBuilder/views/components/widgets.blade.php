...
<div class="all-addons-wrapper">
    <ul id="sortable_02" class="available-form-field all-widgets sortable_02">
        @if(isset($type) && $type === 'tenant')
            ...
            {!! \Plugins\PageBuilder\PageBuilderSetup::get_tenant_admin_panel_widgets($language->slug) !!}
        @else
            {!! \Plugins\PageBuilder\PageBuilderSetup::get_admin_panel_widgets($language->slug) !!}
        @endif
    </ul>
</div>
