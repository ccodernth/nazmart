...
class SocialFollowWidget extends WidgetBase
{
    ...
    public function frontend_render()
    {
        ...
        $markup .= '<div class="footer-widget widget center-text d-flex justify-content-center mt-5" >
                            <h4 class="widget-titile fw-500"> '.$widget_title.' </h4>
                            <div class="footer-inner '.$top_margin.'">
                                <div class="footer-socials">
                                    <ul class="footer-social-list mt-0">
                                        '.$li_markup.'
                                    </ul>
                                </div>
                            </div>
    ...
    {
        return __('Tenant Social Follow: Theme Fruit');
    }
