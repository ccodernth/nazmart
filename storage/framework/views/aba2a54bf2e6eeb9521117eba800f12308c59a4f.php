...
<?php endif; ?>
                            ...
                            <form action="<?php echo e(route(route_prefix().'user.login.otp.verification')); ?>" method="post" enctype="multipart/form-data" class="account-form" id="login_form_order_page">
                               <?php echo csrf_field(); ?>
...
<?php endif; ?></label>
                            ...
                            <p class="info mt-3 d-flex justify-content-between">
                                <a href="<?php echo e(route(route_prefix().'user.login.otp')); ?>" class="active"> <?php echo e(__('Update number?')); ?> </a>
                                <a href="<?php echo e(route(route_prefix().'user.login.otp.resend')); ?>" class="active"> <?php echo e(__('Resend OTP code again?')); ?> </a>
                            </p>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('tenant.frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crux/public_html/core/resources/views/tenant/frontend/user/otp-verify.blade.php ENDPATH**/ ?>