    ...
    <div class="value-input-area">
        ...
        <?php if($productColors->count() > 0 && current(current($productColors))): ?>
            <div
                ...
                <ul class="test size-lists color-list <?php echo e($quickView ? "quick-view-size-lists" : ""); ?>" data-type="Color">
...
<?php /**PATH /home/crux/public_html/core/resources/views/themes/aromatic/frontend/shop/product_details/partials/product-options.blade.php ENDPATH**/ ?>