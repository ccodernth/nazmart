...
<div class="breadcrumb-area breadcrumb-padding section-bg-1 <?php if((in_array(request()->route()->getName(),['landlord.homepage','landlord.dynamic.page']) && $page_post && $page_post->breadcrumb == 0 )): ?>
     d-none
<?php endif; ?>">
...
<?php /**PATH /home/crux/public_html/core/resources/views/landlord/frontend/frontend-page-master.blade.php ENDPATH**/ ?>