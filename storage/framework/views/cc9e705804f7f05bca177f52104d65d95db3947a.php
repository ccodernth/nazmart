                        ...
                        <li class=" menu-item-has-children d-block d-sm-none back mt-3">
                            ...
                            <ul class="sub-menu ">
                                ...
                                <?php $__currentLoopData = get_all_language(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('landlord.setLocale', ['param' => $lang->slug])); ?>">
                                            <img
                        ...
                        <?php if( Auth::guard('web')->check()): ?>
                            <div class="btn-wrapper">
                                ...
                                <a class="cmn-btn cmn-btn-bg-1"
                                   href="<?php echo e($route); ?>"><?php echo e(get_static_option('default_dashboard_text') ?? __('Dashboard')); ?>  </a>
                                <a class="cmn-btn cmn-btn-bg-1"
                                   href="<?php echo e(route('landlord.user.logout')); ?>"><?php echo e(get_static_option('default_logout_text') ?? __('Logout')); ?></a>
                            </div>
                        <?php else: ?>
                            <div class="btn-wrapper">
                                <?php if(get_static_option('default_menu_item') == get_static_option('default_login_text')): ?>
                                    <a href="<?php echo e(route('landlord.user.login')); ?>"
                                       class="cmn-btn cmn-btn-bg-1"><?php echo e(get_static_option('default_login_text') ?? __("Login")); ?></a>
                                <?php elseif(get_static_option('default_menu_item') == get_static_option('default_register_text')): ?>
                                    <a href="<?php echo e(route('landlord.user.register')); ?>"
                                       class="cmn-btn cmn-btn-bg-1"><?php echo e(__("Get Started")); ?></a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('landlord.user.register')); ?>"
                                       class="cmn-btn cmn-btn-bg-1"><?php echo e(__("Get Started")); ?></a>
                                <?php endif; ?>
                            ...
                            <div class="navbar-item has-dropdown is-hoverable lang-dropdown">
                                ...
                                <div class="navbar-dropdown is-boxed  <?php echo e($setLang->direction ? '' : 'is-right'); ?>">
                                    <?php $__currentLoopData = get_all_language(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <a class="navbar-item"
                                           href="<?php echo e(route('landlord.setLocale', ['param' => $lang->slug])); ?>">
                                            <img
                                                src="https://flagcdn.com/w40/<?php echo e(get_lang_flag_name($slug)); ?>.png"
...
<?php /**PATH /home/crux/public_html/core/resources/views/landlord/frontend/partials/navbar.blade.php ENDPATH**/ ?>