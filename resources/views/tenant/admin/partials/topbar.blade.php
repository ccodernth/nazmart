                ...
                <div class="tenant_info_list">
                    ...
                    <div class="tenant_info_list_item">
                        ...
                        <span class="tenant_info_list_para">
                            <span
                                class="{{$blog_count == $permission_limit?->blog_permission_feature ? 'text-danger' : ''}}">{{$blog_count}}</span>
                    ...
                    <div class="tenant_info_list_item product-limits-nav">
                        ...
                        <span class="tenant_info_list_para">
                            <span
                                class="{{$product_count == $permission_limit?->product_permission_feature ? 'text-danger' : ''}}">{{$product_count}}</span>
                    ...
                    <div class="navbar-item has-dropdown is-hoverable lang-dropdown">
                        ...
                        <div class="navbar-dropdown is-boxed  {{ $setLang->direction ? '' : 'is-right' }}">
                            @foreach(get_all_language() as $lang)
                                ...
                                <a class="navbar-item"
                                   href="{{ route('tenant.admin.setLocaleAdmin', ['param' => $lang->slug]) }}">
                                    <img
