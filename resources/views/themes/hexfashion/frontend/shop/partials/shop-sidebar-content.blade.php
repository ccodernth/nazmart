                    ...
                    <form class="price-range-slider" method="post" data-start-min="0" data-start-max="10000" data-min="0" data-max="10000" data-step="5">
                        ...
                        <div class="ui-range-slider-footer">
                            <div class="ui-range-values">
                                ...
                                <div class="price-wrap-outputbox ui-range-value-min">{{site_currency_symbol()}}<span class="min_price">0</span>
                                    <input type="hidden" value="0">
                                </div> -
                                <div class="price-wrap-outputbox ui-range-value-max">{{site_currency_symbol()}}<span class="max_price">10000</span>
